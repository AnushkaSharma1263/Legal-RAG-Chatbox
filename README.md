...
cp .env.example .env
Open .env and replace your_grok_api_key_here with your actual key from https://console.x.ai/.
...
Click "Build Knowledge Base" — this processes and indexes your documents
Type your legal question in the input box at the bottom
Click "Ask ➜" — the chatbot will:
